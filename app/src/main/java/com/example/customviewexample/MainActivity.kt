...
import com.example.customviewexample.task.button.progress.ProgressActivity
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_progress_button.setOnClickListener { startActivity(Intent(this, ProgressActivity::class.java)) }
    }
}
